  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden px-4">
        ...
        <div className="absolute top-32 left-20 w-32 h-32 rounded-full overflow-hidden border-4 border-gold/30 shadow-[var(--shadow-large)] opacity-30 hover:opacity-60 transition-opacity animate-float">
          <img src={adamSmithImg} alt="Adam Smith" className="w-full h-full object-cover" />
        </div>
        <div className="absolute top-48 right-32 w-28 h-28 rounded-full overflow-hidden border-4 border-bronze/30 shadow-[var(--shadow-large)] opacity-30 hover:opacity-60 transition-opacity animate-float-delayed">
          <img src={davidRicardoImg} alt="David Ricardo" className="w-full h-full object-cover" />
        </div>
        <div className="absolute bottom-40 left-32 w-24 h-24 rounded-full overflow-hidden border-4 border-gold/30 shadow-[var(--shadow-large)] opacity-30 hover:opacity-60 transition-opacity animate-float">
